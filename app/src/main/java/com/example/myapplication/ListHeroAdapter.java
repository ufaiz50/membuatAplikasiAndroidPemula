...
public class ListHeroAdapter extends RecyclerView.Adapter<ListHeroAdapter.ListViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ListViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(HalamanDetail.EXTRA_URL, listHero.get(holder.getAdapterPosition())
                        .getPhoto());
                intent.putExtra(HalamanDetail.EXTRA_NAME, listHero.get(holder.getAdapterPosition())
                        .getName());
                intent.putExtra(HalamanDetail.EXTRA_NIM, listHero.get(holder.getAdapterPosition())
                        .getNim());
    ...
    class ListViewHolder extends RecyclerView.ViewHolder {
        ImageView imgPhoto;
        TextView tvName, tvDetail, tvNim, tvProgdi, tvAngkatan;
